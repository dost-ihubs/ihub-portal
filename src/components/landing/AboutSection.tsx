...
export default function AboutSection({
    ...
    /*
     * Validate images whenever hub data changes.
     * Only hubs with working image URLs are kept.
     */
    useEffect(() => {
        let cancelled = false;

        async function validateImages() {
            const hubsWithUrls = hubs.filter(
                (hub) =>
                    hub.image_url &&
                    hub.image_url.trim() !== ""
            );
    ...
    /*
     * Select initial four hubs after
     * image validation finishes.
     */
    useEffect(() => {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start mb-16">
                ...
                <div className="pt-2">
                    <p className="text-slate-700 font-dmsans text-lg leading-relaxed mb-4">
                        The iHub or Innovation Hub is a space where
                        individuals and groups can meet, interact,
                        develop new ideas, and find solutions that
                        address economic and social problems and be
                        ready to become innovative startups. It is a
                        nationwide initiative of the Department of
                        Science and Technology (DOST) to establish
                        iHubs in every province in the Philippines.
                    </p>
