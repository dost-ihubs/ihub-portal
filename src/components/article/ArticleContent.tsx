...
export default function ArticleContent({
    ...
    const renderContent = () => {
        ...
        return (
            <div className="font-dmsans text-[16px] md:text-[17px] leading-8 text-slate-700 space-y-6 mt-10">
    ...
    return (
        <section className="max-w-[1080px] mx-auto px-6 lg:px-12 mb-24 mt-8">
